...
public class SecurityConfigDevelopmentCsrfTests {
  ...
  @Test
  public void csrf_endpoint_is_removed_in_development() throws Exception {
    mockMvc.perform(get("/csrf")).andExpect(status().isNotFound());
  }
